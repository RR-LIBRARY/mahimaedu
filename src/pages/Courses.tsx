...
// Dhyan dein: Yahan humne upar wala Card component import kiya hai
...
// IMPORT FIX: '@' use karne se path ki galti nahi hoti
...
const Courses = () => {
  ...
  const fetchCourses = async () => {
    try {
      ...
      if (data) {
        // Safe Data Logic (Null handle karne ke liye)
        const safeData = data.map((item: any) => ({
          ...
          // Extra dummy data for UI (Optional)
          rating: 4.8,
          duration: "12h 00m",
          lessons_count: 15
        }));
  ...
  // Filtering Logic (String comparison for safety)
